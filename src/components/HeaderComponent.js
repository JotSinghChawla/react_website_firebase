...
import { googleLogin } from '../redux/ActionCreators'

const HeaderComponent = ({ loginUser, logoutUser, auth, googleLogin }) => {
            ...
            <Navbar dark expand='md'>
                <div className="container-fluid">
                    ...
                    <NavbarBrand className='mr-auto'>
                            <img src={ logoURL } alt='Ristorante Con Fusion' height='50' width='70' />
                    </NavbarBrand>
                            ...
                            <NavItem>
                                { !auth.isAuthenticated ? 
                                    <Button outline color='warning' onClick={toggleModal}>
                                        ...
                                        { auth.isLoading ? <span className="fa fa-spinner fa-pulse fa-fw"></span> : null }
                                    </Button>
                                    :
                                    <div>
                                        <p className='navbar-text mr-3 '> Hello { auth.user.email } </p>
            ...
            <Modal isOpen={modalOpen} toggle={toggleModal} >
                ...
                <ModalBody>
                    ...
                    <Form onSubmit={handleLogin}>
                        ...
                        <Button color='danger' onClick={handleGoogleLogin}> <i className='fa fa-google fa-lg'></i> Login with Google </Button>
                    </Form>
                </ModalBody>
            </Modal>
        </>
